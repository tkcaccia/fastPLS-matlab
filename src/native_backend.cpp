...
#if defined(FASTPLS_MATLAB_ACCELERATE)
#define ACCELERATE_NEW_LAPACK
#include <Accelerate/Accelerate.h>
#elif __has_include(<cblas.h>)
#include <cblas.h>
#define FASTPLS_MATLAB_HAS_CBLAS 1
#endif
...
void blas_gemm(fastpls::core::ConstMatrixView<T> left,
               ...
               bool transpose_left, bool transpose_right,
               fastpls::core::MatrixView<T> output) {
#if defined(FASTPLS_MATLAB_ACCELERATE) || defined(FASTPLS_MATLAB_HAS_CBLAS)
...
#elif defined(FASTPLS_MATLAB_HAS_CBLAS)
